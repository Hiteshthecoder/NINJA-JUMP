...
class _MainPageState extends State<MainPage> with SingleTickerProviderStateMixin {
  ...
  List<Obstacle> obstacleList = [Obstacle(positionY: Random().nextDouble(), offsetX: 200)];
  ...
  void _update() {
    ...
    final elapsedSeconds = (worldControllerElapsed - lastUpdateCall).inMilliseconds /
        1000; //TODO: check why using inSeconds is not working here
